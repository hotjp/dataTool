...
(function(factory) {
    ...
    var Utils = {
        isIntercepted: function(a, b) {
            ...
            // return !((a.x + a.width <= b.x || b.x + b.width <= a.x) && a.x + a.width + b.x<=GridStackEngine.width || (a.y + a.height <= b.y || b.y + b.height <= a.y) && GridStackEngine.height);
            // GridStackEngine.width
            // GridStackEngine.height
        },
isIntercepted2: function(a, b,maxWidth,maxHeight) {
            return !(a.x + a.width <= b.x&&a.x + a.width +b.width<=maxWidth || a.y + a.height <= b.y&&a.y + a.height +b.height<=maxHeight || b.x + b.width <= a.x&&b.y + b.height <= a.y);
            // GridStackEngine.width
            // GridStackEngine.height
        },
    ...
    */
    ...
    GridStackEngine.prototype.isAreaEmpty = function(x, y, width, height) {
        ...
        var collisionNode = _.find(this.nodes, _.bind(function(n) {
            return Utils.isIntercepted2(n, nn, this.width,this.height);
        }, this));
