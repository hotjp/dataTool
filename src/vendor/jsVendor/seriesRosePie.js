...
(function(factory) {
  ...
  function seriesRosePie(columns, rows, queryNameKeyX, queryNameKeyY, seriesDefault, series, flag) {
    var nameY = []
          ...
          arr.push({
            ...
            roseType: (function() {
              if (series && series.length) {
                for (var j = 0; j < series.length; j++) {
                  return series[j].roseType || copy.roseType
                }
              } else {
                return copy.roseType
              }
            })(),
            radius: (function() {
              if (series && series.length) {
  ...
  window.seriesRosePie = seriesRosePie;
  return seriesRosePie
})